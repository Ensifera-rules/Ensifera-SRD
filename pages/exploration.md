...
Players choose their exploration speed. Cautious is the default.
* Cautious, inexplored area: 1 turn = 1 room
* Cautious, explored area: 1 turn = 3 rooms
* Fast, inexplored area: 1 turn = 3 rooms
* Fast, explored area: 1 turn = 10 rooms

If you are Slowed (overload, carrying someone in critical condition...), you take double the amount of turns for the same number of rooms.
...
### Doors & locks
* Listening: if you check quickly, 2-in-6 chance (Referee roll) of identifying any audible sound. The undead make no noise. If you spend one turn listening, success is guaranteed.
* Bashing doors: you get a chance to surprise those behind. If the door is defensive, you need to succeed a Vigor test to bash it quickly (it only makes noise, calling an encounter check). If you fail, bashing the door takes 1 turn, makes a lot of noise (2 encounters checks, 1 for time and 1 for noise), and you lose any chance to surprise those behind the door. 
* Lockpicking: with a lockpick and successful Finesse test, you open the door in 1 turn. A failure makes you lose 1 turn in vain and depletes your lockpick. Silently picking a lock gives you the advantage of surprise over any creatures in the room.
...
* If players are smart enough to say where and what they expect and guess well, they spot it instantly, no turn wasted.
...
### Illusions
To break an illusion, you must act with conviction. 
* When faced with something passive, strike it powerfully to prove your disbelief (an object, a wall, a phenomenon, etc).
* When faced with danger, let it strike you to prove that you do not believe in its presence.
