...
### Doors
Many dungeons doors are stuck and must be forced. They open for monsters, however, and magically close if left as is.
...
### Traps
When its conditions are met, a trap triggers with a 2-in-6 chance. Its targets may sometimes get a save against Capture as a last chance to avoid it.
...
# The Grind
Every exploration turn, the Referee draw a card from a 54 classic cards deck with jokers removed.  
If it is a face or ace, something happens:
* ♣ ♠	Encounter
...
#### Shuffle
Shuffle all cards when the group transition from wilderness to dungeon or vice versa, and at the end of each session, or when you feel like it.
